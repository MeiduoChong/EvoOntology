...
def save_json(data_dict: Dict, ftype: str) -> None:
    ...
    def to_json_compatible(value):
        """Recursively convert pandas/NumPy values to standard JSON values."""
    ...
    data_dict = to_json_compatible(data_dict)
    ...
    with open(fname, "w", encoding="utf-8") as f:
        json.dump(data_dict, f, indent=4, ensure_ascii=False, allow_nan=False)
